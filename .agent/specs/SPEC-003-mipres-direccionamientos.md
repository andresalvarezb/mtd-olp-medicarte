...
**Estado externo:** BLOCKED por DEC-013. No implementar el adaptador HTTP real hasta aceptar `../contracts/MIPRES_DIRECCIONAMIENTOS_SANDBOX.md`.
...
Los fixtures de contrato deben provenir del sandbox o ser aprobados contra el esquema oficial; no pueden inventarse para cerrar esta SPEC.
