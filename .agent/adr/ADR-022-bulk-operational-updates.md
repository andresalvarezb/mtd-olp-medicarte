...
Cada tipo define en backend su permiso, precondiciones, esquema exacto, normalización, validación y efectos de dominio. El archivo contiene exactamente `numero_autorizacion`, `codigo_medicamento` y la columna mutable del tipo; columnas adicionales, faltantes o duplicadas invalidan la fila o el archivo según el alcance del error.
