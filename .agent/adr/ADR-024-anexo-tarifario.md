...
4. **Ítems conservados.** Una autorización cuyo producto no está en el Anexo se persiste igualmente (`operation_status = BLOCKED`, membresía `NOT_LISTED`); no se elimina ni se omite. Queda disponible para revalidación posterior y visible en la bandeja transversal de novedades.
...
- Las novedades del Anexo Tarifario se proyectan en la bandeja transversal `novelties`. La descarga on-demand en XLSX se limita al lote seleccionado y expone todas las causales activas de sus registros; una autorización revalidada deja de aparecer por la causal del Anexo.
