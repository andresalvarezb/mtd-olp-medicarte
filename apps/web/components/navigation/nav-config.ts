...
export const ROLE_META: Record<Role, { label: string; selectLabel: string; note: string }> = {
  ...
  MEDICARTE: {
    ...
    selectLabel: 'Medicarte — Aplicación',
...
export const NAV_SECTIONS: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { view: 'mipres', href: '/mipres', title: 'Direccionamientos MIPRES', icon: '04', roles: ['MTD'] },
      { view: 'available', href: '/listos-para-dispensar', title: 'Listos para dispensar', icon: '05', roles: ['MTD', 'OLP', 'MEDICARTE'] },
      { view: 'application', href: '/puntos-de-aplicacion', title: 'Puntos de aplicación', icon: '06', roles: ['MTD', 'MEDICARTE'] },
      { view: 'logistics', href: '/logistica-olp', title: 'Logística OLP', icon: '07', roles: ['MTD', 'OLP'] },
      { view: 'supports', href: '/soportes', title: 'Soportes', icon: '08', roles: ['MTD', 'MEDICARTE'] },
  ...
  },
  {
    label: 'Control',
    items: [
      { view: 'notifications', href: '/notificaciones', title: 'Notificaciones', icon: '10', roles: ['MTD'] },
      { view: 'exports', href: '/consolidado', title: 'Consolidado', icon: '11', roles: ['MTD', 'COMPENSAR', 'OLP', 'MEDICARTE'] },
      { view: 'failures', href: '/fallos-recuperables', title: 'Fallos recuperables', icon: '12', roles: ['MTD'] },
      { view: 'admin', href: '/administracion', title: 'Administración', icon: '13', roles: ['MTD'] },
    ],
  },
];
